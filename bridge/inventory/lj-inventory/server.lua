...
gg.inventory.addItem = function(src, data)
    ...
    local result = exports['lj-inventory']:AddItem(src, data.item, data.count, data.slot, data.metadata)
...
gg.inventory.removeItem = function(src, data)
    ...
    local result = exports['lj-inventory']:RemoveItem(src, data.item, data.count, data.slot, data.reason)
