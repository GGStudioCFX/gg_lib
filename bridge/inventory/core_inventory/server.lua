...
gg.inventory.addItem = function(src, data)
    ...
    local result = exports.core_inventory:addItem(src, data.item, data.count, data.slot, data.metadata)
...
gg.inventory.removeItem = function(src, data)
    ...
    local result = exports.core_inventory:removeItem(src, data.item, data.count, data.slot)
